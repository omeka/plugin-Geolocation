...
<div id="<?php echo $divId; ?>" class="geolocation-map exhibit-geolocation-map" role="region" aria-roledescription="map" aria-label="<?php echo html_escape(__('Geolocation')); ?>"></div>
